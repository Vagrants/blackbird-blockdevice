...
Summary: Block device low level descovery.
Name: %{name}
Version: %{version}
Release: %{release}
...
install -p -m 0644 scripts/blockdevice.cfg $RPM_BUILD_ROOT%{include_dir}/blockdevice.cfg
install -p -m 0644 blockdevice.py $RPM_BUILD_ROOT%{plugins_dir}/blockdevice.py
